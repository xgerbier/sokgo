...
# copy get_IPV6_V6ONLY
mkdir -p $top_dir/get_IPV6_V6ONLY
cd $top_dir/get_IPV6_V6ONLY
gipv6_files="Makefile.am get_IPV6_V6ONLY.c"
for f in $gipv6_files; do
	ln_s ../$ac_rel_dir/get_IPV6_V6ONLY/$f $f
done
